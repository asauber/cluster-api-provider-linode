...
import (
	...
	clusteractuator "github.com/displague/cluster-api-provider-linode/cloud/linode/actuators/cluster"
	"github.com/displague/cluster-api-provider-linode/cloud/linode/controllers/cluster/options"
)

const (
	controllerName = "linode-cluster-controller"
)
...
func Start(server *options.Server, shutdown <-chan struct{}) {
	...
	if err != nil {
		glog.Fatalf("Could not create linode cluster actuator: %v", err)
	}
